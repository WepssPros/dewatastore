...
class ProductGalleryController extends Controller
{
    ...
    {   
        ...
        return view('pages.dashboard.gallery.index', compact('product','transactionpending'));
    }
    ...
    {   
         $transactionpending = Transaction::where('status', "PENDING")->count();
        return view('pages.dashboard.gallery.create', compact('product','transactionpending'));
    }
