...
<div class="relative min-h-screen flex ">
    <div
        ...
        <div class="sm:w-1/2 xl:w-2/5 h-full hidden md:flex flex-auto items-center justify-start p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
            ...
            <a href="#" target="_blank" title="codepen aji"
                class="flex absolute top-5 text-center text-gray-100 focus:outline-none"><img
                    src="{{asset('./admin/assets/images/dewatalogo.PNG')}}" alt="aji"
                    class="object-cover mx-auto  rounded-full w-10 h-10">
                <p class="text-xl ml-3">Dewata<strong>Store Vape</strong></p>
            </a>
            <img src="{{asset('./admin/assets/images/dewatalogo.PNG')}}" class="h-96 absolute right-5 mr-5">
            <div class="w-full  max-w-md z-10">
                <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Dewata Vape Store.
                </div>
                <div class="sm:text-sm xl:text-md text-gray-200 font-normal"> Sistem informasi market place dewata vape
                    store berbasis web</div>
            </div>
            <!---remove custom style-->
            <ul class="circles">
                <li></li>
        ...
        <div
            ...
            <div class="max-w-md w-full space-y-8">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Please Login in to your account</p>
                </div>
                <div class="flex flex-row justify-center items-center space-x-3">
                    ...
                    </a><a href="https://twitter.com/ajeemon?lang=en" target="_blank"
                    ...
                    </a><a href="https://in.linkedin.com/in/ajeeshmon" target="_blank"
                ...
                <form class="mt-8 space-y-6" action="{{route('login')}}" method="POST">
                    ...
                    <div class="relative">
                        ...
                        <input name="email" required
                            ...
                            type="email" placeholder="mail@gmail.com" value="mail@gmail.com">
                    </div>
