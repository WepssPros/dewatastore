...
<div class="d-flex justify-content-between align-items-center gap-3">
    ...
    <a href="{{route('dashboard.category.create')}}" class="btn-link">+ Buat Kategori Baru</a>

</div>
<div class="d-flex gap-4 flex-wrap">
    @forelse ($categorys as $item)
    <div class="product-card">
        <img src="{{asset('./admin/assets/images/nike_airforce.png')}}" alt="Nike Airforce" width="260" height="180" />
        <div class="product-detail pt-3">
            <div>
                <p class="label-detail mb-1">{{$item->name}}</p>
        ...
        <div class="product-detail pt-4">
            <div>
                <p class="label-detail mb-1"></p>
                <p class="price-detail">Start</p>
            </div>
