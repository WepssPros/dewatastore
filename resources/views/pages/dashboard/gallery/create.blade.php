                    ...
                    <form action="{{ route('dashboard.product.gallery.store', $product->id) }}" method="post"
                        ...
                        <div class="pt-6 border-gray-300 mt-2 px-7">
                            <p class="text-base font-semibold leading-4 text-gray-800">
                                Gallery Product &raquo; {{ $product->name }} &raquo; Gallery &raquo; Upload
                                Photos
                            </p>
                            <div class="mt-10 border border-gray-300 rounded">
                                ...
                                <input multiple accept="image/*" value="{{ old('files') }}" name="files[]" class="w-full p-3 mt-4 border border-gray-300 rounded outline-none
                                    focus:bg-gray-50" id="grid-last-name" type="file" placeholder="Gallery Files">
                            </div>
                        </div>
