        ...
        <div class="w-full">
            <div class="py-4 px-2">
                <div class="bg-white rounded shadow mt-7 py-7">
                    ...
                    <!-- end -->
                    <form action="{{route('dashboard.stock.store')}}" method="post" enctype="multipart/form-data">

                        @csrf
                        <div class="mt-10 px-7">
                            <p class="text-xl font-semibold leading-tight text-gray-800">
                                Tambah &raquo;Stock &raquo; Produk
                            </p>
                            ...
                            <div class="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7">
                                ...
                                <div>
                                    ...
                                    <select name="products_id" class="w-full p-3 mt-4 border border-gray-300 rounded outline-none
                                         focus:bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <input name="stock_in" type="number"
                                        class="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" />
                                    <p class="mt-3 text-xs leading-3 text-gray-600">
                                ...
                                <div>
                                    ...
                                    <input name="tanggal" type="date"
                                        class="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" />
                                    <p class="mt-3 text-xs leading-3 text-gray-600">
                                        Masukan Tanggal Stock Baru yang tersedia
                                    </p>
                                </div>
