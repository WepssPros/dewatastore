    ...
    <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
            ...
            <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                <p
                    ...
                    Home / Detail / {{$product->category->name}} / {{$product->name}}</p>
                <h2
                ...
                <div class="flex flex-row justify-between mt-5">
                    <img class="dark:hidden"
                        src="{{('https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg1.svg')}}" alt="stars">
                    ...
                    <div class="lg:mt-11 mt-10">
                        <div class="flex flex-row justify-between">
                            ...
                            <div class="flex">
                                ...
                                <input id="counter" aria-label="input" name="quantity"
                        ...
                        <div class="flex flex-row justify-between items-center mt-4">
                            ...
                            <img onclick="rotate()" id="rotateSVG"
                                ...
                                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/svg4.svg" alt="dropdown">
                            <img onclick="rotate()" id="rotateSVG"
                                ...
                                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/svg4dark.svg" alt="dropdown">
                        </div>
            ...
            <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                ...
                <div class="w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-100 flex justify-center items-center py-4">
                        <img src="{{ ($item->url) }}" alt="Wooden chair - preview 1" />
                    </div>
        ...
        <div class="flex justify-center items-center w-full">
            <div
                ...
                <div>
                    <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg2.svg"
                        alt="drink">
                    <img class="hidden dark:block"
                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg2dark.svg" alt="drink">
                    <p class="font-semibold text-xl leading-5 text-gray-800 dark:text-white lg:mt-10 mt-9">Great for
                        drinks</p>
                    <p class="text-normal text-base leading-6 text-gray-600  mt-4">Here are all the great cocktail
                        recipes you should know how to make, from the margarita to the whiskey sour. Cheers!</p>
                </div>
                <div>
                    <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg3.svg"
                        alt="hardware">
                    <img class="hidden dark:block"
                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg3dark.svg" alt="hardware">
                    <p class="font-semibold text-xl leading-5 text-gray-800 dark:text-white lg:mt-10 mt-9">Durable
                        hardware</p>
                    <p class="text-normal text-base leading-6 text-gray-600  mt-4">Product durability is a key aspect of
                        achieving a circular economy. ... Moreover, enhancing the durability of individual hardware
                        components</p>
                </div>
                <div>
                    <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg5.svg"
                        alt="Eco-friendly">
                    <img class="hidden dark:block"
                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg5dark.svg"
                        alt="Eco-friendly">
                    <p class="font-semibold text-xl leading-5 text-gray-800 dark:text-white lg:mt-10 mt-9">Eco-friendly
                    </p>
                    <p class="text-normal text-base leading-6 text-gray-600  mt-4">They re-use, recycle and reduce waste
                        disposal in their lives. They conserve energy and natural resources</p>
                </div>
                <div>
                    <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg6.svg"
                        alt="drink">
                    <img class="hidden dark:block"
                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/productDetail4-svg6dark.svg" alt="drink">
                    <p class="font-semibold text-xl leading-5 text-gray-800 dark:text-white lg:mt-10 mt-9">Minimal
                        Design</p>
                    <p class="text-normal text-base leading-6 text-gray-600  mt-4">Minimalist interior design is very
                        similar to modern interior design and involves using the bare essentials</p>
                </div>
            </div>
        </div>
    </div>
